...
return [
    'baseUrl' => (env('APP_ENV') !== 'production'?'https://sandbox.plaid.com/':'https://production.plaid.com/'),
    'client_id' => (env('APP_ENV') !== 'production'?'client_id':env('PLAID_CLIENT_ID')),
    'secret' => (env('APP_ENV') !== 'production'?'secret':env('PLAID_SECRET')),
    'public_key' => (env('APP_ENV') !== 'production'?'public_key':env('PUBLIC_KEY')),
    'prefix' => 'plaid',
    'autoupgrade' => true,
    'auth' => [
        'list' => false,
